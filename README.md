...
- Réglage « Afficher le week-end » (menu ⋯) : samedi et dimanche dans les deux vues, comme les autres jours. Désactivé, les tâches datées d'un week-end gardent leur date et s'affichent le lundi suivant ; le samedi et le dimanche, c'est le lundi qui tient lieu d'aujourd'hui (colonne surlignée, progression, focus)
